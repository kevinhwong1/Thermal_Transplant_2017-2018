...
#PHOTOSYNTHESIS
path.p<-"~/Documents/Projects/Thermal_Acclimation_2017/Data/Colony_Respirometry/T1_clay/" #the location of all your respirometry files
...
for(i in 1:length(file.names)) { # for every file in list start at the first and run this following function
  ...
  for(j in 1:length(lt.levs)){    
    ...
    pdf(paste0("~/Documents/Projects/Thermal_Acclimation_2017/Output/Colony_Photo_Resp_Output/T1",rename,"_",j,"thinning.pdf"))
    ...
    pdf(paste0("~/Documents/Projects/Thermal_Acclimation_2017/Output/Colony_Photo_Resp_Output/T1",rename,"_",j,"regression.pdf"))
    plot(Regs)
    dev.off()
