...
# path.p<-"../Data/Colony_Respirometry/" #the location of all your respirometry files 
# 
...
# 
# #PHOTOSYNTHESIS
# path.p<-"~/MyProjects/Thermal_Acclimation_2017/Data/Colony_Respirometry/T1_clay/" #the location of all your respirometry files
...
#     pdf(paste0("~/MyProjects/Thermal_Acclimation_2017/Output/Colony_Photo_Resp_Output/T1",rename,"_",j,"thinning.pdf"))
...
#     pdf(paste0("~/MyProjects/Thermal_Acclimation_2017/Output/Colony_Photo_Resp_Output/T1",rename,"_",j,"regression.pdf"))
#     plot(Regs)
#     dev.off()
#     
...
# 
# write.csv(Photo, file="~/MyProjects/Thermal_Acclimation_2017/Output/Colony_Photo_Resp_Output/Photosynthesis.rates.T1.csv")
# write.csv(Resp, file="~/MyProjects/Thermal_Acclimation_2017/Output/Colony_Photo_Resp_Output/Respiration.rates.T1.csv")
# 
